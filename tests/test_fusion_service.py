...
async def test_process_snapshot(monkeypatch):
    ...
    # Mock everything
    async def mock_get_latest_seq(*args): return 0
    async def mock_update_seq(*args): pass
    async def mock_get_state(*args): return None
    async def mock_update_seen(*args): pass
    async def mock_get_samples(*args): return []
    async def mock_save_samples(*args): pass
    async def mock_save_state(*args): pass
    async def mock_get_last_seen(*args): return None
    ...
    async def mock_publish(*args): pass
    async def mock_broadcast(*args): pass
