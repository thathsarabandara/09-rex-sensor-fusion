...
from app.routes import fusion, health
...
async def test_line_sensor_coverage():
    ...
    line_sensor.get_line_position(
        {"left_outer": True, "left_inner": True, "right_inner": False, "right_outer": False}
    )
    line_sensor.get_line_position(
        {"left_outer": False, "left_inner": False, "right_inner": True, "right_outer": True}
    )
    line_sensor.get_line_position(
        {"left_outer": False, "left_inner": True, "right_inner": True, "right_outer": False}
    )
